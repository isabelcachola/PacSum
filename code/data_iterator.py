    ...
    def _parse_file2doc_tfidf(self, file_name):
        ...
        with h5py.File(file_name,'r') as f:
            for j_str in f['dataset']:
                ...
                article, abstract, paper_id = obj['article'], obj['abstract'], obj['paper_id']
            ...
            for j_str in tqdm(f['dataset']):
                ...
                for i in range(len(article)):
                    for j in range(i+1, len(article)):
                        ...
                        k+=1
                yield article_token_ids, article_seg_ids, article_token_ids_c, article_seg_ids_c, pair_indice, article, abstract, paper_id

    def _doc_iterate_bert(self, docs):

        for article_token_ids, article_seg_ids, article_token_ids_c, article_seg_ids_c, pair_indice, article, abstract, paper_id in docs:

            if len(article_token_ids) == 0:
                yield None, None, None, None, None, None, pair_indice, article, abstract, paper_id
                continue
            ...
            yield  article, abstract, paper_id, (out_x, out_t, out_w, out_x_c, out_t_c, out_w_c, pair_indice)
